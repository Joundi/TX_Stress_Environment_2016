...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarController : MonoBehaviour
    {
        ...
        {
            // Wheel Collider doesn't work properly here
            /*
            for (int i = 0; i < 4; i++)
            {
                Quaternion quat;
            ...
            //clamp input values
            m_SteeingWheel.Rotate(steering);
        ...
        private void CapSpeed()
        {
            ...
            m_speedMonitor.SetCurrentSpeed(speed, m_Topspeed); // 1.5f for the speed seems more realistic
        }
        ...
        void FixedUpdate()
        {
            ...
            Vector3 relativeVelocity = transform.InverseTransformDirection(m_Rigidbody.velocity);
            if (Mathf.Abs(relativeVelocity.z) < 0.001) //round down to zero
